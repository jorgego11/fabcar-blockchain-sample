            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        message = 'Evaluate failed with the following errors: %j' + errorMessages;
 ...
 */
exports.createQueryHandlerOrg1 = function (network) {
    var channel = network.getChannel();
    var peers = channel.getPeersForOrg('org1msp');
 ...
 * @returns {QueryHandler} A query handler implementation.
 */
exports.createQueryHandlerOrg2 = function (network) {
    var channel = network.getChannel();
    var peers = channel.getPeersForOrg('org2msp');
    return new SampleQueryHandler(peers);
};
